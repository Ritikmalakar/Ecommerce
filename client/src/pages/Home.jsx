...
export default function Home() {
  ...
  const filterProduct = async () => {
    try {
      const { data } = await baseUrl2.post("/filter", {
        checked,
        radio,
      });
  ...
  useEffect(() => {
    ...
    const searched = getSearchProduct();
  ...
  return (
    <Layout>
      <div className="container-fluid">
        {/* Filter Button */}
        <div className="mb-3">
          <button className="btn btn-dark" onClick={() => setShowFilter(true)}>
            ☰ Filter
          </button>
        </div>
          ...
          {showFilter && (
            <>
              ...
              >
                ...
                {/* Price */}
                <Price radio={radio} setRadio={setRadio} />
